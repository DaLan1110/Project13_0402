...
if ($data != "") {
    ...
    if (isset($mydata["ID"]) && $mydata["ID"] != "") {
        ...
        $sql = "DELETE member_account, member_personal FROM member_account INNER JOIN member_personal ON member_account.Id = member_personal.userId WHERE member_account.Id IN ($m_ID)";
